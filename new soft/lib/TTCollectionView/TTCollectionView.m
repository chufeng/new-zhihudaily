...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UILabel *title=[[UILabel alloc] initWithFrame:CGRectMake(10, self.frame.size.height-52, kScreenWidth-90, 42)];
...
- (void)setImagesCount:(NSInteger)imagesCount {
    ...
    // page控制
    self.page = [[UIPageControl alloc] initWithFrame:CGRectMake(kScreenWidth - 90, CGRectGetMaxY(self.frame)-20, 100, 20)];
    ...
    UIImageView *shadowImg=[[UIImageView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.frame)-80, kScreenWidth, 80)];
    printf("%f",CGRectGetMaxY(self.frame));
    shadowImg.image=[UIImage imageNamed:@"shadow.png"];
    [self.superview addSubview:shadowImg];
}
// 这里是添加计时器的
